...
# ====================================================================
STATIONS = ['ILL13','ILL18']
BASE_PATH = "/content"
out="/content/drive/MyDrive/Colab Notebooks/ML_Mutiai_debris_flow/no_rf/"
SEQUENCE_LENGTH = 10
...
ENSEMBLE_MODE = os.getenv("ENSEMBLE_MODE", "no_rf")
