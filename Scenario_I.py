...
BASE_PATH = "/content"
out="/content/drive/MyDrive/Colab Notebooks/ML_Mutiai_debris_flow/all_par/"
SEQUENCE_LENGTH = 10
...
def preprocess_data(station, base_path=BASE_PATH):
    ...
    feature_cols = [
        ...
        if c not in (['Label','time_window_start','month'])
    ]
    feature_cols = sorted(feature_cols)
    print(f"[Ablation-ALL] Using {len(feature_cols)} features (no selection; month kept for logic, others dropped).")
